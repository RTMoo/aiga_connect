    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-card border-border">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl text-white mb-1">Аслан Кудайбергенов</h2>
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <div className="space-y-3">
          {[
            { name: "Амир Назарбаев", age: 16, belt: "Синий пояс", grade: "A" },
            { name: "Данияр Султанов", age: 14, belt: "Белый пояс", grade: "B+" },
            { name: "Айдар Каимов", age: 15, belt: "Синий пояс", grade: "A-" }
          ].map((student, index) => (
            <div key={index} className="flex items-center justify-between p-3 bg-secondary rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">{student.age} лет • {student.belt}</p>
                </div>
              </div>
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Тренировок в месяц</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Чемпионств выиграно</div>
          </div>
        </div>
      </Card>
    </div>
  ...
  const renderParentProfile = () => (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <div className="space-y-3">
          {[
            { action: "Завершил тренировку", time: "2 часа назад", type: "success" },
            { action: "Пропустил тренировку", time: "1 день назад", type: "warning" },
            { action: "Обновление прогресса от тренера", time: "3 дня назад", type: "info" }
          ].map((activity, index) => (
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-card border-border">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl text-white mb-1">Амир Назарбаев</h2>
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-muted-foreground">Золотая медаль</div>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6 bg-card border-border">
        ...
        <div className="space-y-3">
          {[
            { title: "Получение синего пояса", date: "Март 2024", icon: Trophy },
            { title: "Победитель турнира", date: "Февраль 2024", icon: Award },
            { title: "Идеальная посещаемость", date: "Январь 2024", icon: Star }
